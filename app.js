...
let currentLanguage = localStorage.getItem('cpgLanguage') === 'vi' ? 'vi' : 'en';
...
function setLanguage(lang) {
  ...
  localStorage.setItem('cpgLanguage', currentLanguage);
  ...
  if (!maplibreInstance) {
    ...
    MAP_LOCATIONS.forEach(loc => {
      ...
      el.innerHTML = loc.type === 'star' ?
        `<span class="mnode-pulse star-pulse"></span><span class="mnode-dot star-dot"></span><span class="mnode-label cpg-label">${loc.name}</span>` :
